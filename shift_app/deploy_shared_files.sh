...
cat > supabase/functions/_shared/dictionary.ts << 'SHIFTEOF_DICT'
...
cat > supabase/functions/_shared/prompt_engine.ts << 'SHIFTEOF_PROMPT'
...
cat > supabase/functions/_shared/note_resolver.ts << 'SHIFTEOF_NOTE'
...
echo "✅ שלושת קבצי ה-_shared (dictionary.ts, prompt_engine.ts, note_resolver.ts) נכתבו בהצלחה תחת supabase/functions/_shared/."
