...
cat > 'lib/features/auth/presentation/auth_screen.dart' << 'SHIFTEOF'
...
echo ""
echo "✅ תוקן: קונפליקט TextDirection בין easy_localization/intl לבין dart:ui (Member not found: 'ltr'). עכשיו: flutter analyze ואז flutter build apk --debug."
