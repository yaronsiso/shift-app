...
echo "== שלב 1: מעדכן את ה-Flutter SDK (זו התקנה מ-2023, זה ייקח כמה דקות) =="
flutter channel stable
flutter upgrade

echo ""
echo "--- גרסה אחרי העדכון ---"
flutter --version

echo ""
echo "== שלב 2: מוודא שהתיקייה android/ עדיין תקינה =="
